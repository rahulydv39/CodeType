...
export const JavaScriptIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path d="M0 0h24v24H0V0zm17.51 4.24c0-1.24-.96-2.24-2.2-2.24H8.7c-.33 0-.6.27-.6.6v15.2c0 .33.27.6.6.6h5.88c1.24 0 2.2-.99 2.2-2.24V16.9c0-.33-.27-.6-.6-.6h-3.08v-2.03h3.08c.33 0 .6-.27.6-.6V9.9c0-.33-.27-.6-.6-.6h-3.08V7.28h3.08c.33 0 .6-.27.6-.6V4.24z" />
  </svg>
);
